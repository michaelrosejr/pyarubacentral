...
class Configuration():
    ...
    def __init__(self, sessiondata, pvalue, data):
    ...
    def get_configuration_v1_devices_template_variables(self):
        ...
        Get template variables for all devices, Response is sorted by device_seri
            None
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/template_variables"
    ...
    def get_configuration_v1_devices_device_serial_recover_device(self):
        ...
        Get template variables for all devices, Response is sorted by device_seri
            None
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/recover_device"
    ...
    def get_configuration_v1_certificates(self):
        ...
        Get Certificates details upload
            None
        """
        url = self.baseurl + "/configuration/v1/certificates"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_mode_device(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/mode/device"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_msp_templates_differences_device_type_version_model(self):
        ...
        Get customers & groups where given MSP level template is not applie
            Get customers & groups where given MSP level template is not applie
        """
        url = self.baseurl + "/configuration/v1/msp/templates/differences/" + self.pvalue + "/" + self.pvalue + "/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_mode_group(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/mode/group"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_groups_group_templates(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/groups/" + self.pvalue + "/templates"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_groups_default_group(self):
        ...
        Get default gro
            Get default gro
        """
        url = self.baseurl + "/configuration/v1/groups/default_group"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_msp_templates_device_type_version_model(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/msp/templates/" + self.pvalue + "/" + self.pvalue + "/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_groups_group_templates_template(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/groups/" + self.pvalue + "/templates/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_devices_device_serial_variablised_template(self):
        ...
        Get variabilised template for a devi
			...
			-  -----END VARIABLES---
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/variablised_template"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_devices_move(self):
        ...
        Get variabilised template for a devi
			...
			-  -----END VARIABLES---
        """
        url = self.baseurl + "/configuration/v1/devices/move"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_groups(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/groups"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_mode(self):
        ...
        Get config mode as either Monitor or Managed mode at customer lev
            Get config mode as either Monitor or Managed mode at customer lev
        """
        url = self.baseurl + "/configuration/v1/mode"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_groups_group(self):
        ...
        Get gro
            Get gro
        """
        url = self.baseurl + "/configuration/v1/groups/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_devices_device_serial_clis(self):
        ...
        Get gro
            Get gro
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/clis"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_certificates_certificate(self):
        ...
        Get gro
            Get gro
        """
        url = self.baseurl + "/configuration/v1/certificates/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_devices_device_serial_config_details(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/config_details"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_cplogo(self):
        ...
        Get Captive Portal Logos upload
            None
        """
        url = self.baseurl + "/configuration/v1/cplogo"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_devices_device_serial_ssh_connection(self):
        ...
        Get Captive Portal Logos upload
            None
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/ssh_connection"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_devices_device_serial_group(self):
        ...
        Get group for a devi
            None
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/group"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_msp_templates_differences_customer_cid_device_type_version_model(self):
        ...
        Get groups where given END customer level template is not applie
            Get groups where given END customer level template is not applie
        """
        url = self.baseurl + "/configuration/v1/msp/templates/differences/customer/" + self.pvalue + "/" + self.pvalue + "/" + self.pvalue + "/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_devices_device_serial_assign_mm_mm_name(self):
        ...
        Get groups where given END customer level template is not applie
            Get groups where given END customer level template is not applie
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/assign_mm/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_msp_templates(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/msp/templates"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_devices_device_serial_configuration(self):
        ...
        Get last known running configuration for a devi
            None
        """
        url = self.baseurl + "/configuration/v1/devices/" + self.pvalue + "/configuration"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_groups_group_clis_(self):
        ...
        Get last known running configuration for a devi
            None
        """
        url = self.baseurl + "/configuration/v1/groups/" + self.pvalue + "/clis/"
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_msp_templates_customer_cid_device_type_version_model(self):
        ...
        Get END customer level template te
            Get MSP level template te
        """
        url = self.baseurl + "/configuration/v1/msp/templates/customer/" + self.pvalue + "/" + self.pvalue + "/" + self.pvalue + "/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_cplogo_checksum(self):
        ...
        Get END customer level template te
            Get MSP level template te
        """
        url = self.baseurl + "/configuration/v1/cplogo/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
    ...
    def get_configuration_v1_msp_templates_customer_cid(self):
        ...
        """
        url = self.baseurl + "/configuration/v1/msp/templates/customer/" + pvalue
        response = push_central(self.access_token, self.refresh_token, url)
        return response
