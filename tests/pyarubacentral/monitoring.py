...
class Monitoring():
    ...
    def __init__(self, sessiondata, pvalue):
        self.access_token = sessiondata['access_token']
        self.refresh_token = sessiondata['refresh_token']
        self.pvalue = pvalue
        self.baseurl = sessiondata['baseurl']
    ...
    def get_monitoring_v1_wids_interfering_aps(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/wids/interfering_aps"
    ...
    def get_monitoring_v1_wids_rogue_aps(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/wids/rogue_aps"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_aps_serial_rf_summary(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/aps/" + pvalue + "/rf_summary"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_aps_serial(self):
        ...
        AP Detai
            Get AP detail
        """
        url = self.baseurl + "/monitoring/v1/aps/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_events(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/events"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_networks_network_name(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/networks/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_central_v1_labels(self):
        ...
        List Labe
			...
			4. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/central/v1/labels"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_networks(self):
        ...
        List all Networ
			...
			3. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/networks"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_clients_count(self):
        ...
        Total Clients Cou
			...
			4. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/clients/count"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_aps(self):
        """
        List Access Poin
            Get access points. You can only specify one of group, swarm_id
            , label parameters.
			Possible error_codes for the error responses are
			1. 0001 - General Error.
			2. 0002 - Validation Error. Out of Range value for a query parameter.
			...
			4. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/aps"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_mobility_controllers_serial_ports(self):
        ...
        Mobility Controllers Ports Detai
			...
			1. 0001 - General Error
        """
        url = self.baseurl + "/monitoring/v1/mobility_controllers/" + pvalue + "/ports"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v2_aps_serial_rf_summary(self):
        ...
        AP RF Summa
			...
			3. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v2/aps/" + pvalue + "/rf_summary"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switches(self):
        ...
        List Switch
			...
			4. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/switches"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_wids_client_attacks(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/wids/client_attacks"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_central_v1_labels_associations(self):
        ...
        List Client Attac
            Get client attacks over a time perio
        """
        url = self.baseurl + "/central/v1/labels/associations"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_clients_bandwidth_usage(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/clients/bandwidth_usage"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_clients_wired_macaddr(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/clients/wired/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_mobility_controllers_uplinks_bandwidth_usage(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/mobility_controllers/uplinks/bandwidth_usage"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_attribute_values(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/attribute_values"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_aps_serial_neighbouring_clients(self):
        ...
        AP Neighbouring Clien
			...
			3. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/aps/" + pvalue + "/neighbouring_clients"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_vpn_usage(self):
        ...
        Swarm VPN sta
			...
			3. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/vpn/usage"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switch_stacks(self):
        ...
        Switch Stack Detai
            List Switch Stack
        """
        url = self.baseurl + "/monitoring/v1/switch_stacks"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_central_v1_labels_categories(self):
        ...
        """
        url = self.baseurl + "/central/v1/labels/categories"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switches_serial(self):
        ...
        Switch Detai
            Get Switch detail
        """
        url = self.baseurl + "/monitoring/v1/switches/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switches_serial_ports(self):
        ...
        Switch Ports Detai
			...
			1. 0001 - General Error
        """
        url = self.baseurl + "/monitoring/v1/switches/" + pvalue + "/ports"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_clients_wireless_macaddr_mobility_trail(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/clients/wireless/" + pvalue + "/mobility_trail"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_networks_bandwidth_usage(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/networks/bandwidth_usage"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_mobility_controllers_serial_tunnels(self):
        ...
        Mobility Controllers Uplink Tunnel Detai
			...
			1. 0001 - General Error
        """
        url = self.baseurl + "/monitoring/v1/mobility_controllers/" + pvalue + "/tunnels"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_swarms_swarm_id(self):
        ...
        Swarm Detai
            Get Swarm detail
        """
        url = self.baseurl + "/monitoring/v1/swarms/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_clients_bandwidth_usage_topn(self):
        ...
        Top N Clien
			...
			3. 0003 - Validation Error. Unsupported query combinatio
        """
        url = self.baseurl + "/monitoring/v1/clients/bandwidth_usage/topn"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_clients_wireless_macaddr(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/clients/wireless/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_swarms(self):
        ...
        List Swar
			...
			3. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/swarms"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switches_serial_ports_errors(self):
        ...
        Switch Ports Erro
			...
			2. 0002 - Validation Error. Out of Range value for a query parameter
        """
        url = self.baseurl + "/monitoring/v1/switches/" + pvalue + "/ports/errors"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_wids_infrastructure_attacks(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/wids/infrastructure_attacks"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switches_bandwidth_usage(self):
        ...
        Switch Bandwidth Usa
			...
			3. 0003 - Validation Error. Unsupported query combinatio
        """
        url = self.baseurl + "/monitoring/v1/switches/bandwidth_usage"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switch_stacks_stack_id_ports(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/switch_stacks/" + pvalue + "/ports"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switch_stacks_stack_id(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/switch_stacks/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_vpn_info(self):
        ...
        Vpn Detai
            Get VPN detail
        """
        url = self.baseurl + "/monitoring/v1/vpn/info"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_mobility_controllers_serial(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/mobility_controllers/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_clients_wired(self):
        ...
        List Wired Clien
			...
			4. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/clients/wired"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_aps_bandwidth_usage(self):
        ...
        AP Bandwidth Usa
			...
			5. 0005 - Validation Error. Missing required parameter
        """
        url = self.baseurl + "/monitoring/v1/aps/bandwidth_usage"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_mobility_controllers(self):
        ...
        List Mobility Controlle
			...
			4. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/mobility_controllers"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_wids_events(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/wids/events"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_aps_bandwidth_usage_topn(self):
        ...
        Top N AP Detai
			...
			3. 0003 - Validation Error. Unsupported query combinatio
        """
        url = self.baseurl + "/monitoring/v1/aps/bandwidth_usage/topn"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switches_serial_chassis_info(self):
        ...
        Switch Chassis Detai
			...
			1. 0001 - General Error
        """
        url = self.baseurl + "/monitoring/v1/switches/" + pvalue + "/chassis_info"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_mobility_controllers_uplinks_wan_compression_stats(self):
        ...
        Uplink WAN compression sta
			...
			5. 0005 - Validation Error. Missing required parameter
        """
        url = self.baseurl + "/monitoring/v1/mobility_controllers/uplinks/wan_compression_stats"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switches_bandwidth_usage_topn(self):
        ...
        Top N Switch
			...
			3. 0003 - Validation Error. Unsupported query combinatio
        """
        url = self.baseurl + "/monitoring/v1/switches/bandwidth_usage/topn"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_aps_serial_uplink_history(self):
        ...
        AP uplink histo
			...
			1. 0002 - Validation Error. Out of Range value for a query parameter
        """
        url = self.baseurl + "/monitoring/v1/aps/" + pvalue + "/uplink_history"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_switches_serial_ports_bandwidth_usage(self):
        ...
        Switch Ports Bandwidth Usa
			...
			2. 0002 - Validation Error. Out of Range value for a query parameter
        """
        url = self.baseurl + "/monitoring/v1/switches/" + pvalue + "/ports/bandwidth_usage"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_central_v1_labels_label_id(self):
        ...
        Label detai
            Get a label detail
        """
        url = self.baseurl + "/central/v1/labels/" + pvalue
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_mobility_controllers_serial_ports_bandwidth_usage(self):
        ...
        Mobility Controllers Ports Bandwidth Usa
			...
			2. 0002 - Validation Error. Out of Range value for a query parameter
        """
        url = self.baseurl + "/monitoring/v1/mobility_controllers/" + pvalue + "/ports/bandwidth_usage"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_clients_wireless(self):
        ...
        List Wireless Clien
			...
			4. 0004 - Validation Error. Invalid value for a query paramete
        """
        url = self.baseurl + "/monitoring/v1/clients/wireless"
        response = get_central(self.sessiondata, url)
        return response
    ...
    def get_monitoring_v1_bssids(self):
        ...
        """
        url = self.baseurl + "/monitoring/v1/bssids"
        response = get_central(self.sessiondata, url)
        return response
